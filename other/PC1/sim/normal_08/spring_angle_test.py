...
def run1(k):
    ...
    file_path = "success_rate_Kpa10.txt"
    ...
    #相対パスで保存
    #plt.savefig(fr'./data/link_{k}.png')
...
def run2(k):
    ...
    # file_angle = 'spring-angle.csv'
    # file_vec = 'spring-vec.csv'
    file_path = "success_rate_ka20.txt"
...
def run3(k):
    ...
    # file_angle = 'spring-angle.csv'
    # file_vec = 'spring-vec.csv'
    file_path = "success_rate_ka30.txt"
...
def run4(k):
    ...
    # file_angle = 'spring-angle.csv'
    # file_vec = 'spring-vec.csv'
    file_path = "success_rate_ka40.txt"
...
def run5(k):
    ...
    # file_angle = 'spring-angle.csv'
    # file_vec = 'spring-vec.csv'
    file_path = "success_rate_ka50.txt"
...
def run6(k):
    ...
    # file_angle = 'spring-angle.csv'
    # file_vec = 'spring-vec.csv'
    file_path = "success_rate_ka60.txt"
...
def run7(k):
    ...
    # file_angle = 'spring-angle.csv'
    # file_vec = 'spring-vec.csv'
    file_path = "success_rate_ka70.txt"
...
def run8(k):
    ...
    # file_angle = 'spring-angle.csv'
    # file_vec = 'spring-vec.csv'
    file_path = "success_rate_ka80.txt"
...
def run9(k):
    ...
    # file_angle = 'spring-angle.csv'
    # file_vec = 'spring-vec.csv'
    file_path = "success_rate_ka90.txt"
...
def run10(k):
    ...
    # file_angle = 'spring-angle.csv'
    # file_vec = 'spring-vec.csv'
    file_path = "success_rate_ka100.txt"
...
def run11(k):
    ...
    # file_angle = 'spring-angle.csv'
    # file_vec = 'spring-vec.csv'
    file_path = "success_rate_ka110.txt"
...
def run12(k):
    ...
    # file_angle = 'spring-angle.csv'
    # file_vec = 'spring-vec.csv'
    file_path = "success_rate_ka95.txt"
...
def run13(k):
    ...
    # file_angle = 'spring-angle.csv'
    # file_vec = 'spring-vec.csv'
    file_path = "success_rate_D20.txt"
...
def run14(k):
    ...
    # file_angle = 'spring-angle.csv'
    # file_vec = 'spring-vec.csv'
    file_path = "success_rate_D30.txt"
...
def run15(k):
    ...
    # file_angle = 'spring-angle.csv'
    # file_vec = 'spring-vec.csv'
    file_path = "success_rate_D40.txt"
...
def run16(k):
    ...
    # file_angle = 'spring-angle.csv'
    # file_vec = 'spring-vec.csv'
    file_path = "success_rate_D50.txt"
...
def run17(k):
    ...
    # file_angle = 'spring-angle.csv'
    # file_vec = 'spring-vec.csv'
    file_path = "success_rate_D60.txt"
...
def run18(k):
    ...
    # file_angle = 'spring-angle.csv'
    # file_vec = 'spring-vec.csv'
    file_path = "success_rate_D70.txt"
...
def run19(k):
    ...
    # file_angle = 'spring-angle.csv'
    # file_vec = 'spring-vec.csv'
    file_path = "success_rate_D80.txt"
...
def run21(k):
    ...
    # file_angle = 'spring-angle.csv'
    # file_vec = 'spring-vec.csv'
    file_path = "success_rate_D9ka90.txt"
...
if __name__ == '__main__':
    ...
    with tqdm(total=max - min) as pbar:
        for i, _ in enumerate(p.imap_unordered(run1, ((range(min, max))))):
            pbar.update()
    
    with tqdm(total=max - min) as pbar:
        for i, _ in enumerate(p.imap_unordered(run2, ((range(min, max))))):
            pbar.update()
    
    with tqdm(total=max - min) as pbar:
        for i, _ in enumerate(p.imap_unordered(run3, ((range(min, max))))):
            pbar.update()
            
    with tqdm(total=max - min) as pbar:
        for i, _ in enumerate(p.imap_unordered(run4, ((range(min, max))))):
            pbar.update()
            
    with tqdm(total=max - min) as pbar:
        for i, _ in enumerate(p.imap_unordered(run5, ((range(min, max))))):
            pbar.update()
            
    with tqdm(total=max - min) as pbar:
        for i, _ in enumerate(p.imap_unordered(run6, ((range(min, max))))):
            pbar.update()
            
    with tqdm(total=max - min) as pbar:
        for i, _ in enumerate(p.imap_unordered(run7, ((range(min, max))))):
            pbar.update()
            
    with tqdm(total=max - min) as pbar:
        for i, _ in enumerate(p.imap_unordered(run8, ((range(min, max))))):
            pbar.update()
            
    with tqdm(total=max - min) as pbar:
        for i, _ in enumerate(p.imap_unordered(run9, ((range(min, max))))):
            pbar.update()
            
    with tqdm(total=max - min) as pbar:
        for i, _ in enumerate(p.imap_unordered(run10, ((range(min, max))))):
            pbar.update()
            
    with tqdm(total=max - min) as pbar:
        for i, _ in enumerate(p.imap_unordered(run11, ((range(min, max))))):
            pbar.update()
            
    with tqdm(total=max - min) as pbar:
        for i, _ in enumerate(p.imap_unordered(run12, ((range(min, max))))):
            pbar.update()
            
    with tqdm(total=max - min) as pbar:
        for i, _ in enumerate(p.imap_unordered(run13, ((range(min, max))))):
            pbar.update()
            
    with tqdm(total=max - min) as pbar:
        for i, _ in enumerate(p.imap_unordered(run14, ((range(min, max))))):
            pbar.update()
            
    with tqdm(total=max - min) as pbar:
        for i, _ in enumerate(p.imap_unordered(run15, ((range(min, max))))):
            pbar.update()
            
    with tqdm(total=max - min) as pbar:
        for i, _ in enumerate(p.imap_unordered(run16, ((range(min, max))))):
            pbar.update()
            
    with tqdm(total=max - min) as pbar:
        for i, _ in enumerate(p.imap_unordered(run17, ((range(min, max))))):
            pbar.update()
            
    with tqdm(total=max - min) as pbar:
        for i, _ in enumerate(p.imap_unordered(run18, ((range(min, max))))):
            pbar.update()
            
    with tqdm(total=max - min) as pbar:
        for i, _ in enumerate(p.imap_unordered(run19, ((range(min, max))))):
            pbar.update()
            
    with tqdm(total=max - min) as pbar:
        for i, _ in enumerate(p.imap_unordered(run20, ((range(min, max))))):
            pbar.update()
        
    with tqdm(total=max - min) as pbar:
        for i, _ in enumerate(p.imap_unordered(run21, ((range(min, max))))):
            pbar.update()
