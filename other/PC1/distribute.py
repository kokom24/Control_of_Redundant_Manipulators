...
def joint_processor(theta_negative,theta_positive,pos_negative,pos_positive,v_negative,v_positive,L):
    # Calculate dL
    spring_leng = (math.sqrt((pos_positive[0]-pos_negative[0])**2 + (pos_positive[1]-pos_negative[1])**2))
    dL = spring_leng - L

    # Calculate angle
    angle_rad = math.atan2(pos_positive[1]-pos_negative[1], pos_positive[0]-pos_negative[0])
...
def run(file_path, m, L, g, k, b, dt, joint_num, goal_pos):
   ...
   # Set joint parameters
    ...
    while t < tmax:
        ...
        # Set target position
        EE_x = target_pos_x[count]
        EE_y = target_pos_y[count]
        ...
        v_negative = 0
        v_positive = 0
        joint_processor(theta_negative,theta_positive,pos_negative,pos_positive,v_negative,v_positive,L)
