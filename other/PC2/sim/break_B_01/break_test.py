...
def process_joint(broken_joint):
    ...
    return success_count, try_count, broken_joint
...
if __name__ == '__main__':
    ...
    # Prepare the list of joints to process
    broken_joints = [[i] for i in range(10)]
    ...
    #     # Use tqdm to display progress
        # results = list(pool.imap(process_joint, broken_joints))

    results = []
    for broken_joint in broken_joints:
        results.append(process_joint(broken_joint))

    # Collect results and calculate the overall success rate
    for success_count, try_count, broken_joint in results:
