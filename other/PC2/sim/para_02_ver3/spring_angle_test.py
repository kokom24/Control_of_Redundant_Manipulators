...
def runge_kutta_n(L, K, D, n, theta_0, x_vec, dt,end_eff_x,end_eff_y, judge, t, fail_count, angle, count):
    ...
    #print("k1:",k1)
    k2, dL , angle, fail_count = f_n(L, K, D, n, theta_0, x_vec,end_eff_x,end_eff_y,judge,t,fail_count, angle, count)
    #print("k2:",k2)
    k3, dL , angle, fail_count = f_n(L, K, D, n, theta_0, x_vec,end_eff_x,end_eff_y,judge,t,fail_count, angle, count)
    #print("k3:",k3)
    k4, dL , angle,fail_count = f_n(L, K, D, n, theta_0, x_vec,end_eff_x,end_eff_y,judge,t,fail_count, angle, count)
    # #print("k4:",k4)
...
def run1(k):            
    ...
    #相対パスで保存
    # plt.savefig(fr'./data/K100vsD10/link_{k}.png')
...
def run2(k):            
    ...
    # plt.savefig(fr"C:\Users\81808\Documents\GitHub\study_B4\test_all\013_multi\data\link_{k}.png")
    #相対パスで保存
    # plt.savefig(fr'./data/K10vsD10/link_{k}.png')
...
def run3(k):            
    ...
    # plt.savefig(fr"C:\Users\81808\Documents\GitHub\study_B4\test_all\013_multi\data\link_{k}.png")
    #相対パスで保存
    # plt.savefig(fr'./data/K20vsD10/link_{k}.png')
...
def run5(k):            
    ...
    # plt.savefig(fr"C:\Users\81808\Documents\GitHub\study_B4\test_all\013_multi\data\link_{k}.png")
    #相対パスで保存
    # plt.savefig(fr'./data/K40vsD10/link_{k}.png')
...
def run6(k):            
    ...
    # plt.savefig(fr"C:\Users\81808\Documents\GitHub\study_B4\test_all\013_multi\data\link_{k}.png")
    #相対パスで保存
    # plt.savefig(fr'./data/K50vsD10/link_{k}.png')
...
def run7(k):            
    ...
    # plt.savefig(fr"C:\Users\81808\Documents\GitHub\study_B4\test_all\013_multi\data\link_{k}.png")
    #相対パスで保存
    # plt.savefig(fr'./data/K60vsD10/link_{k}.png')
...
def run8(k):            
    ...
    # plt.savefig(fr"C:\Users\81808\Documents\GitHub\study_B4\test_all\013_multi\data\link_{k}.png")
    #相対パスで保存
    # plt.savefig(fr'./data/K70vsD10/link_{k}.png')
...
def run9(k):            
    ...
    # plt.savefig(fr"C:\Users\81808\Documents\GitHub\study_B4\test_all\013_multi\data\link_{k}.png")
    #相対パスで保存
    # plt.savefig(fr'./data/K80vsD10/link_{k}.png')
...
def run10(k):            
    ...
    # plt.savefig(fr"C:\Users\81808\Documents\GitHub\study_B4\test_all\013_multi\data\link_{k}.png")
    #相対パスで保存
    # plt.savefig(fr'./data/K90vsD10/link_{k}.png')
...
def run11(k):            
    ...
    # plt.savefig(fr"C:\Users\81808\Documents\GitHub\study_B4\test_all\013_multi\data\link_{k}.png")
    #相対パスで保存
    # plt.savefig(fr'./data/K100vsD50/link_{k}.png')
...
def run12(k):            
    ...
    # plt.savefig(fr"C:\Users\81808\Documents\GitHub\study_B4\test_all\013_multi\data\link_{k}.png")
    #相対パスで保存
    # plt.savefig(fr'./data/K100vsD80/link_{k}.png')
