    ...
    for i in range(dis_range): 
        ...
        for r, pos in enumerate(joint_positions):
            if r == 0:
                ...
                if pos[0] > 100 or pos[1] > 100 or pos[0] < -100 or pos[1] < -100 or dL > ran*10 or dL < -ran*10 or judge_success <= r-1 :
                    print("\n************************************************************")
