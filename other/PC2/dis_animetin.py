...
def run(m, L, g, k, b, dt, joint_num, goal_pos):
    # Set parameters
   ...
   # Set joint parameters
    ...
    while t < tmax:
        ...
        # print("fail_angle:", np.degrees(fail_angle))
        # print("normal_angle:", np.degrees(normal_angle))
        #計算されたマニピュレータのリンクの描画
        for i in range(joint_num): 
            if i ==0:
...
if __name__ == '__main__':
    ...
    run(m, L, g, k, d, dt, joint_num, goal_position)
